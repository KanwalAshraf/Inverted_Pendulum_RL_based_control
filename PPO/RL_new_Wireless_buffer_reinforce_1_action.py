...
class Agent:
    ...
    def train(self, max_episodes=100, max_steps=1000):
        ...
        with open('mydata_maxreward_500_packet_new_action.csv', mode='w', newline='') as csv_file:
...
# Train the agent
torch.save(agent.net.state_dict(), 'model_noisy_v1_action.pt')
...
filename = 'maxreward_500%_packet_new_run_episodes_action.csv'
